...
export class FormsClient {
    ...
    getForms(justActive: boolean , cancelToken?: CancelToken | undefined): Promise<FormListAm> {
        let url_ = this.baseUrl + "/api/v1/core/forms/{justActive}";
        if (justActive === undefined || justActive === null)
            throw new Error("The parameter 'justActive' must be defined.");
        url_ = url_.replace("{justActive}", encodeURIComponent("" + justActive));
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetForms(response: AxiosResponse): Promise<FormListAm> {
        ...
        if (status === 200) {
            ...
            return Promise.resolve<FormListAm>(result200);

        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Promise.resolve<FormListAm>(null as any);
    }
    ...
    protected processGet(response: AxiosResponse): Promise<FormAm> {
        ...
        if (status === 200) {
            ...
            return Promise.resolve<FormAm>(result200);
...
export class OrderClient {
    ...
    protected processGetOrders(response: AxiosResponse): Promise<OrderListAm> {
        ...
        if (status === 200) {
            ...
            return Promise.resolve<OrderListAm>(result200);

        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Promise.resolve<OrderListAm>(null as any);
    }
...
export class PositionsClient {
    ...
    protected processGetPositions(response: AxiosResponse): Promise<PositionListAm> {
        ...
        if (status === 200) {
            ...
            return Promise.resolve<PositionListAm>(result200);

        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Promise.resolve<PositionListAm>(null as any);
    }
    ...
    protected processGet(response: AxiosResponse): Promise<PositionAm> {
        ...
        if (status === 200) {
            ...
            return Promise.resolve<PositionAm>(result200);

        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Promise.resolve<PositionAm>(null as any);
    }
...
export class SystemSettingsClient {
    ...
    protected processGet(response: AxiosResponse): Promise<SystemSettings> {
        ...
        if (status === 200) {
            ...
            return Promise.resolve<SystemSettings>(result200);

        } else if (status !== 200 && status !== 204) {
            const _responseText = response.data;
            return throwException("An unexpected server error occurred.", status, _responseText, _headers);
        }
        return Promise.resolve<SystemSettings>(null as any);
    }
}
